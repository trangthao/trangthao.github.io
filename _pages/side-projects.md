...
Welcome! [*Ngắm Kinh Tế*](https://github.com/trangthao/side-projects/blob/main/patents-web-scraping/match_patents_firmid.ipynb) is a platform dedicated to exploring and discussing industrial policy and the economics of innovation to a Vietnamese audience. My goal is to bridge the gap between academic research and practical application, making complex economic concepts accessible to a wider audience. Here, I share in-depth analyses on the forces shaping our world.
